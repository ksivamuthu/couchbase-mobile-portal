...
- Expiry value for local documents managed by Sync Gateway ([databases.$db.local_doc_expiry_secs](../../../guides/sync-gateway/config-properties/index.html#2.0/databases-foo_db-local_doc_expiry_secs))
